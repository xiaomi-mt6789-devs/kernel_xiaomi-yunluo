...
static struct fw_update_checklist need_update_k[] = {
	...
	{"WDC", "SDINDDK4-64G", "2000", "2008",
	(uint64_t)WDC_2008, sizeof(WDC_2008)},
	{"YMTC", "YMUS7B2TE1A2C1", "3.1", "3.2",
	(uint64_t)YMTC_0302, sizeof(YMTC_0302)},
	{"YMTC", "YMUS8B2TE2A2C1", "3.1", "3.2",
	(uint64_t)YMTC_0302, sizeof(YMTC_0302)},
};
